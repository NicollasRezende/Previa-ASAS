...
export function RegistrationPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.acceptPrivacyPolicy) newErrors.acceptPrivacyPolicy = 'Você deve aceitar a política de privacidade';
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      // Implemente aqui a lógica de envio do formulário
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormSection>
            ...
            <CheckboxContainer>
              ...
              />
              <CheckboxLabel>
                Li e aceito os <Link to="/termos">Termos de Uso</Link> do Projeto ASAS
              </CheckboxLabel>
            </CheckboxContainer>
            ...
            <CheckboxContainer>
              ...
              />
              <CheckboxLabel>
                Li e aceito a <Link to="/privacidade">Política de Privacidade</Link> do Projeto ASAS
              </CheckboxLabel>
            </CheckboxContainer>
            {errors.acceptPrivacyPolicy && <ErrorMessage>{errors.acceptPrivacyPolicy}</ErrorMessage>}
          </FormSection>
